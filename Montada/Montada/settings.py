...
# Benzinga live news
BENZINGA_API_TOKEN = os.environ.get(
    "BENZINGA_API_TOKEN",
    "bz.N5EGPWM5JRXNCABXOX7REWL35XDNKIWX",
)
BENZINGA_NEWS_URL = os.environ.get(
    "BENZINGA_NEWS_URL",
    "https://api.benzinga.com/api/v2/news",
)
BENZINGA_NEWS_STREAM_URL = os.environ.get(
    "BENZINGA_NEWS_STREAM_URL",
    "wss://api.benzinga.com/api/v1/news/stream",
)
BENZINGA_NEWS_DEFAULT_PAGE_SIZE = int(
    os.environ.get("BENZINGA_NEWS_DEFAULT_PAGE_SIZE", "50")
)
